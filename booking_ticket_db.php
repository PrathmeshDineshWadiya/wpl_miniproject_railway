...
{
$insert = $conn->query("INSERT INTO booking_ticket(source,destination,date,time,aadhaar_no,seat_type,ticket_type,category,vaccination_status,total_ticket) VALUES ('$sourceStation','$destinationStation','$date','$current_time','$aadhaarCard','$seatType','$ticketType','$category','$vaccinationStatus','$totalTicket')");
